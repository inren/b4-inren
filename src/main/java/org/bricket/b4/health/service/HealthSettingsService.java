 ...
 *
 */
public interface HealthSettingsService extends B4Service {

    HealthSettings load(long id);
    
    HealthSettings loadByUser(Long uid) throws B4ServiceException;
    
    HealthSettings save(HealthSettings healthSettings) throws B4ServiceException;
