 ...
 * 
 */
public class Gmap3Page<T> extends DefaultPage<T> {

    private static final CssResourceReference CSS = new CssResourceReference(Gmap3Page.class, "Gmap3BootstrapFix.css");
    ...
    public Component createPanel(String wicketId) {
        return new Gmap3Panel(wicketId);
    }
